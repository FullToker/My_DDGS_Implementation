...
def render_set(model_path, name, iteration, views, gaussians, pipeline, background, resol=1):
    ...
    for idx, view in enumerate(tqdm(views, desc="Rendering progress")):
        ...
        render_pkg = render(view, gaussians, pipeline, background,
                           depth_weight=args.depth_weight, density_weight=args.density_weight,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--drop_min", type=float, default=0.0)
    parser.add_argument("--drop_max", type=float, default=0.0)
    parser.add_argument("--mask_param", type=int, default=None)
